...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="<?=APP_URL?>/public/assets/css/default.css">
    <link rel="stylesheet" href="<?=APP_URL?>/public/assets/css/home.css">
    <link rel="stylesheet" href="<?=APP_URL?>/public/assets/css/navios-fornecidos.css">
                  ...
                  <div class="form-add-fornecimento-wrapper px-4 py-3">
                    ...
                    <form action="<?=APP_URL?>/navios-fornecidos/editar" method="post">
                        ...
                        <div class="form-group d-flex flex-column mb-4">
                            ...
                            <input type="text" name="ship-acronym" id="ship-acronym" class="text-white px-1 py-1 rounded" value="<?=$ship->acronym;?>">
                        </div>
                        <div class="form-group d-flex flex-column mb-4">
                        ...
                        <div class="form-group d-flex flex-column mb-4">
                            <label for="ship-supply" class="mb-2">Data do fornecimento:</label>
                            <input type="date" name="ship-supply" id="ship-supply" class="text-white px-1 py-1 rounded" value="<?=$ship->supply_date;?>">
                        </div>
                        <div class="form-group d-flex flex-column mb-4">
